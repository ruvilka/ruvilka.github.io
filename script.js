...
document.querySelector('.submit-button').addEventListener('click', function(e) {
    ...
    .then((res) =>{
        ...
        document.querySelector('#form-h1').classList.add('success');
        document.querySelector('#form-h3').classList.add('success');
        $('#form-h1').text('Анкета успешно отправленна!');
        $('#form-h3').text('Специалист скоро свяжется с вами');
        document.querySelector('#form-h3').classList.add('success');
        $('#name').css('visibility', 'hidden');
        $('#phone').css('visibility', 'hidden');
        $('#email').css('visibility', 'hidden');
        document.querySelector('.vd1').classList.add('success');
        document.querySelector('.vd2').classList.add('success');
        document.querySelector('.vd3').classList.add('success');
        document.querySelector('.vd4').classList.add('success');
        document.querySelector('.vd5').classList.add('success');
    })
    .catch((err) =>{
        console.warn(err)
    })
...
$(document).ready(function(){
    $('#bc5b1').click(function(){
     ...
     $('#bc5b2').click(function(){
        window.location.href = 'tel:88003336655';
    });
